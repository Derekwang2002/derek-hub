...
This document has been rechecked against `s-eleven-mcp` revision `b36ac02f`. “Current system” describes existing code; “next step” explicitly marks work that has not landed.
...
See [Runtime Status and Next Steps](/projects/call-e/development-plan) for the current priority and incomplete boundaries of this work.
